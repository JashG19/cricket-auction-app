  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary to-darkBg flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full">
        <h1 className="text-3xl font-bold text-primary text-center mb-2">Cricket Auction</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Password Field */}
          <div>
            <label className="block text-text font-semibold mb-2">Password</label>
            <input
              type="password"
              value={password}
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <p className="text-sm text-blue-700">Check your Firebase console for credentials</p>
        </div>
      </div>
    </div>
  )
